...
function DoRoundFixes()
{
	...
	if ( HasPlayerControlledZombies() )
	{
		...
		make_ladder( "_ladder_barrelsemi_cloned_signfence", "2976 6278 -907", "11502.29 11689.9 299", "0 150 0", "-0.49 -0.86 0" );
		...
		make_ladder( "_ladder_qolbus_cloned_caralarmbus", "1878 4279 -911", "2571.03 7794.04 341", "0 295 0", "0.49 -0.87 0" );
		...
		make_ladder( "_ladder_slopetruck_cloned_caralarmbus", "1773 4270 -911", "2858.21 11302.38 312.5", "0 252 0", "0.23 0.97 0" );
		...
		make_ladder( "_ladder_tankfightsemi_cloned_signfence", "2976 6278 -907", "7355.9 -120.29 -5", "0 60 0", "-0.86 0.49 0" );
