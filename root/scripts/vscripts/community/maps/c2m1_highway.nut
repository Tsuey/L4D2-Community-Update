...
function DoRoundFixes()
{
	...
	if ( HasPlayerControlledZombies() )
	{
		...
		make_ladder( "_ladder_barrelsemi_cloned_caralarmshort", "2976 6278 -907", "11502.29 11689.9 299", "0 150 0", "-0.49 -0.86 0" );
		make_ladder( "_ladder_endbusfront_cloned_caralarmshort", "1773 4270 -911", "1997 662.16 -112", "0 150 0", "0.9 -0.43 0" );
		make_ladder( "_ladder_endbusback_cloned_caralarmshort", "1773 4270 -911", "-5485.06 -5007.16 -112", "0 330 0", "-0.9 0.43 0" );
		...
		make_ladder( "_ladder_qolbus_cloned_caralarmshort", "1878 4279 -911", "2571.03 7794.04 341", "0 295 0", "0.49 -0.87 0" );
		...
		make_ladder( "_ladder_shrubberybus_cloned_caralarmshort", "1773 4270 -911", "2272.93 4677.83 225", "0 330 0", "-0.90 0.43 0" );
		make_ladder( "_ladder_slopetruck_cloned_caralarmshort", "1773 4270 -911", "2858.21 11302.38 312.5", "0 252 0", "0.23 0.97 0" );
		...
		make_ladder( "_ladder_tankfightsemi_cloned_caralarmshort", "2976 6278 -907", "7355.9 -120.29 -5", "0 60 0", "-0.86 0.49 0" );
